import { faEllipsisVertical, faArrowsRotate, faComment, faHeart, faShareNodes } from "@fortawesome/free-solid-svg-icons";
                ...
                <View style={styles.tweetContainer}>
                    ...
                    <View style={styles.tweet}>
                       <View style={styles.userDetails}>
                            ...
                            <Text style={[globalStyles.text, {marginLeft:5, fontWeight:'500'} ]}>@hellog . 3h</Text>
                            <FontAwesomeIcon icon={faEllipsisVertical} size={15} color='lightgrey' style={styles.menuIcon} />
                       </View>

                       <Text style={[styles.userTweet, globalStyles.text]}>Merhaba, cok iyi. </Text>
